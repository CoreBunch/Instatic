...
/** Internal language-specific 404 key, separate from an authored page /404. */
export function notFoundArtefactPath(localeId: string): string {
  return `/_instatic/not-found/${Buffer.from(localeId).toString('hex')}`
}
