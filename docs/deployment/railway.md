...
```txt
Image=ghcr.io/corebunch/instatic:0.0.15
PORT=8080
...
- Use a semver tag like `ghcr.io/corebunch/instatic:0.0.15` when you want Railway to stage matching patch or minor updates according to the service's auto-update preference.
