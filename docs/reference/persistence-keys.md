...
|-------------------------------------------|-----------------------------------------------------------------------|-----------------------------------------------------------------|
| `instatic-admin-locale-v1`                      | Explicit admin UI locale selected with the language switcher; absent or invalid means English | `src/admin/i18n/localePreference.ts` → `ADMIN_LOCALE_STORAGE_KEY` |
